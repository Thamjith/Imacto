...
import { type CompressToolState } from "@/constants/tools"
import { type LoadedImage } from "@/lib/imageUpload"

const PRESETS = ["Lossless", "Balanced", "Smallest"]

interface CompressPanelProps {
  state: CompressToolState
  set: (patch: Partial<CompressToolState>) => void
  image?: LoadedImage | null
}

export function CompressPanel({ state, set, image }: CompressPanelProps) {
  return (
    <>
